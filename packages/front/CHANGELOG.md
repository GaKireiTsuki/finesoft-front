...
- Auto-generated patch release from CI (2c35ce1).
- 2c35ce1: Require Hono 4.13.5 or newer in framework peers and generated applications. Update the locked Vitest family to 4.1.11, js-yaml to 3.15.2/4.3.2 and devalue to 5.9.2 while retaining the stable Vite+ 0.2.8 toolchain.
...
- Auto-generated patch release from CI (c80eb43).
