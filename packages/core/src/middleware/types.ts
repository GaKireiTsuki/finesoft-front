...
export type MiddlewareResult = NextResult | RedirectResult | RewriteResult | DenyResult;
...
export type AfterLoadGuard = (ctx: PostLoadContext) => MiddlewareResult | Promise<MiddlewareResult>;
