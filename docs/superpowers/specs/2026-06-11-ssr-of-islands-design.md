...
export function islandContainerAttributes(intent: string, entryKey: string): Record<string, string> {
...
export function renderIslandsHtml(snapshot: NavigationSnapshot, renderEntry: RenderEntry): Promise<string>;
```
